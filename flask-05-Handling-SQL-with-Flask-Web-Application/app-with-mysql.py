...
# asagidaki ilk 5 satiri konfigure etmemiz gerekiyor, yoksa calismaz
app.config['MYSQL_DATABASE_HOST'] =  # here write end-point
app.config['MYSQL_DATABASE_USER'] =  # here write your user name
app.config['MYSQL_DATABASE_PASSWORD'] =  # here write your password
app.config['MYSQL_DATABASE_DB'] =  # here write your database name
